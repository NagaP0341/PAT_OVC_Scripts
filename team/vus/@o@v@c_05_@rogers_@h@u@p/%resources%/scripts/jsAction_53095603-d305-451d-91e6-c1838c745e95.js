...
context.variableManager.setValue("C_Accountdetailsjs_accountAlias",accountAlias);//DBy30S5U65IX17K-zXCccA==
context.variableManager.setValue("C_Accountdetailsjs_customerBillingProfileId",customerBillingProfileId);
context.variableManager.setValue("C_Accountdetailsjs_ecId",ecId);//457148263
context.variableManager.setValue("C_Accountdetailsjs_homePhone",homePhone);//1111111111
context.variableManager.setValue("C_Accountdetailsjs_email",email);//Rogers_SSP_20230901@mailinator.com
...
context.variableManager.setValue("C_Accountdetailsjs_streetNumber",streetNumber);//8200
context.variableManager.setValue("C_Accountdetailsjs_streetName",streetName);//DIXIE
context.variableManager.setValue("C_Accountdetailsjs_streetType",streetType);//RD
