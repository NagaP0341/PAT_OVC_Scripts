...
// Inject the computed value in a runtime variable
 context.variableManager.setValue("c_plan_skuId",Plans_planId);//sku_plan_CCMM4225N_CCMM4225N
   context.variableManager.setValue("c_externalId_3",Plans_externalId);  //CCMM4225N
//    context.variableManager.setValue("c_Plans_atgSkuId",Plans_atgSkuId);  //CCMM4225N
   context.variableManager.setValue("c_skuId_1",autoDeploySocs_skuId);  //sku_addon_sku2780327_sku2780327
   context.variableManager.setValue("c_externalId_1",autoDeploySocs_externalId);  //TAGSRA6PB
