...
for (var i = 0; i<tilesData.length;++i){
    ...
    Selected_DeviceProductID = tilesData[1]['id'];
    Selected_cheapestSkuId =  tilesData[1]['cheapestSkuId'];
...
//         }
  ...
  context.variableManager.setValue("C_Selected_DeviceProductID",Selected_DeviceProductID); //device_prodIP16
  context.variableManager.setValue("C_Selected_cheapestSkuId",Selected_cheapestSkuId); //iphone-16
