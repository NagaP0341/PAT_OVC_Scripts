...
equipmentNo = currentPlanInfo['equipmentNo'];
  ...
  context.variableManager.setValue("C_EligibilityDetailsjs_eligibilityID",eligibilityID);  //474695627
  context.variableManager.setValue("C_EligibilityDetailsjs_atgSkuId",atgSkuId); //sku2060326
  context.variableManager.setValue("C_EligibilityDetailsjs_planTierCode",planTierCode); //SMALL
